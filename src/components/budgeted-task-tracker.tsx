  ...
  if (!activeTasks.length) {
    return (
      <div className="w-full">
        <h3 className="text-lg font-semibold text-foreground mb-4">Budgeted Task Tracker</h3>
        <p className="text-sm text-muted-foreground text-center py-10">No active budgeted tasks. Add tasks in Tasks section or check if existing tasks have expired.</p>
      </div>
    );
  }
